...
public static class Items 
{
    ...
    public static IDefensa Escudo { get; } = new Item { Nombre = "Escudo", Defensa = 50, EsMagico = false};
    public static IAtaque Arco { get; } = new Item { Nombre = "Arco", Ataque = 25, EsMagico = false};
    public static IDefensa Armadura { get; } = new Item { Nombre = "Armadura", Defensa = 40, EsMagico = false};
